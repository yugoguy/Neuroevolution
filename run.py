...
# %% Put the module files alongside this notebook, then import.
# (Upload genome.py, graph_utils.py, innovation.py, init_population.py, mutation.py,
#  crossover.py, speciation.py, stagnation.py, reproduction.py, converter.py,
#  dataset.py, train.py, recorder.py, viz.py, config.py, orchestrator.py.)
import sys
