...
def speciate(
    ...
    generation (empty on the first generation). `rep_selection` chooses each
    surviving species' next representative: "random" member or "first" member.
    Returns (assignment per genome, new representatives).
    """
